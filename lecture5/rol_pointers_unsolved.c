void updateStats(/*Unknown parameters*/, int item) {
    //Health potion increases health in 10
	// Strength potion increases strenght in 10
	//Agility potion increases agility in 7
}
